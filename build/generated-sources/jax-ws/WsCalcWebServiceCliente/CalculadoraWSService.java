 ...
 * 
 */
@WebServiceClient(name = "CalculadoraWSService", targetNamespace = "http://calculadoraws/", wsdlLocation = "http://localhost:8080/calcws?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULADORAWSSERVICE_QNAME = new QName("http://calculadoraws/", "CalculadoraWSService");
    ...
    public CalculadoraWS getCalculadoraWSPort() {
        return super.getPort(new QName("http://calculadoraws/", "CalculadoraWSPort"), CalculadoraWS.class);
    }
    ...
    public CalculadoraWS getCalculadoraWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://calculadoraws/", "CalculadoraWSPort"), CalculadoraWS.class, features);
    }
